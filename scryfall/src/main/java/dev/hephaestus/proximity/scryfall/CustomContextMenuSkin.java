 ...
 * @since 9
 */
public class CustomContextMenuSkin implements Skin<ContextMenu> {
     ...
     */
    public CustomContextMenuSkin(final ContextMenu control) {
        this.popupMenu = control;

        popupMenu.addEventHandler(Menu.ON_SHOWING, new EventHandler<>() {
            @Override
        ...
        popupMenu.addEventHandler(Menu.ON_SHOWN, new EventHandler<>() {
            ...
            public void handle(Event event) {
                ...
                if (cmContent != null) {
                    if (cmContent instanceof CustomContextMenuContent) {
                        Node accMenu = ((CustomContextMenuContent) cmContent).getItemsContainer();
        ...
        popupMenu.addEventHandler(Menu.ON_HIDDEN, new EventHandler<>() {
            @Override
            public void handle(Event event) {
                Node cmContent = popupMenu.getSkin().getNode();
        ...
        root = new CustomContextMenuContent(popupMenu);
    ...
    private void performPopupShifts() {
        ...
        double shiftY = prefHeight - rootPrefHeight;
        ...
        double shiftX = prefWidth - rootPrefWidth;
